                        ...
                        the_post(); ?>
                                <div class="row">
                                        ...
                                        <div class="col-12">
                                                <!--<a href="<?php bloginfo(
                                                    "url"
                                                ); ?>/telegram/" id="go-back"><i class="fa-solid fa-arrow-left" aria-label="Retour en arrière"></i></a>-->
                                                <h2 class="single-subtitle"><?= get_field(
                                                    "subtitle_post"
                                                ) ?></h2>
                                                                ...
                                                                <a class="c-4" href="<?php the_permalink(); ?>">
                                                                        ...
                                                                        <div class="gs-card-img-overlay d-flex align-items-end justify-content-center text-left">
                                                                                <div class="gs-overlay-text p-3">
                                                                                        ...
                                                                                        <h5 class="card-subtitle c-3 mt-2 mb-2"><?= get_field(
                                                                                            "sous-titre-playlist"
                                                                                        ) ?></h5>
                                                                                </div>
                                                                        </div>
